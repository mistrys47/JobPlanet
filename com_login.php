...
border:none;color:black;background:Transparent;font-size:15pt;font-family:cursive;" onclick="location.href='homepage.php'" value="Homepage">Homepage</button>
    ...
    <center><br><br>
    <br><br><br><br>
    <h2 style="font-family:courier;">Find the perfect employee for your company and make the world more cherishing.</h2>
    </center>

    <center>
      <form method="post" class="form" action = "comLogin1.php">
