...
$con=mysqli_connect("127.0.0.1","root","")or
  ...
  $i=0;
          while($row = mysqli_fetch_array( $result ) )
          {
            ...
            echo '<input type="checkbox"  name="day[]"  value=" '.$row["id"].' " />';echo "</td>";
            echo "</tr>";
  ...
  //      print_r (employee[0]);
        ...
        echo '<input style="border:none;width:100px;height:25px;font-size:9pt;" type="submit" name="submit" value="Submit" />';
        echo "</center>";
        echo "</form>";
